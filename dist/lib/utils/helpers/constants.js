...
function generateConstants(presetType, mode) {
    const constants = presetType === "Typescript"
        ...
        : presetType === "Javascript"
            ...
            : presetType === "Vue"
                ? stringParser(`const { VueLoaderPlugin } = require("vue-loader/lib/plugin")`)
                : presetType === "React"
                    ? parseString("")
                    : presetType === "Svelte"
                        ? parseString("")
    ...
    const modeConstants = mode === "production" &&
        ...
        ? stringParser("const HtmlMinimizerPlugin = require('html-minimizer-webpack-plugin');\n const MiniCssExtractPlugin = require('mini-css-extract-plugin');\n const CssMinimizerPlugin = require('css-minimizer-webpack-plugin');\n const TerserPlugin = require('terser-webpack-plugin');\n")
        : stringParser(`const WebpackNotifierPlugin = require('webpack-notifier');`);
    return `
