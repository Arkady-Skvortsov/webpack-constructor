...
import { optimizeProductionCSS, optimizeProductionHTML, outputFileName, setCssPlugin, setCSSRuleUse, setHTMLPreset, setTerserPlugin, setVueLoader, setWatchFiles, } from "./dev-mode";
import { generateExtensions } from "./helpers/extensions";
import { isHtmlWebpackPlugin, LinterChoose, setWebpackNotifierPlugin, } from "./helpers/plugins";
...
module.exports = {
  ...
  module: {
    rules: [
      ...
      {
        test: /\.s(a|c)ss$/,
        use: [${setCSSRuleUse(options.devMode, type)}, "css-loader", "sass-loader"],
      },
      {
